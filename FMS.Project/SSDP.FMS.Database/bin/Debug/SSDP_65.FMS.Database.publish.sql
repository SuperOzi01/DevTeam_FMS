...
GO
PRINT N'Altering Procedure [dbo].[SP_CanceledServiceRequests]...';


GO
ALTER PROCEDURE [dbo].[SP_CanceledServiceRequests]
AS
...
AS
	...
	ELSE
		...
		END
GO
PRINT N'Altering Procedure [dbo].[SP_GetAllCanceledRequests]...';


GO
ALTER PROCEDURE [dbo].[SP_GetAllCanceledRequests]
AS
	Select * FROM RequestView Where dbo.RequestView.RequiestStatus = (select dbo.RequestStatus.RequestStatusID from dbo.RequestStatus Where dbo.RequestStatus.StatusName like '%Cancel%')
GO
PRINT N'Altering Procedure [dbo].[SP_GetMMApprovedRequests]...';


GO
ALTER PROCEDURE [dbo].[SP_GetMMApprovedRequests]
AS
