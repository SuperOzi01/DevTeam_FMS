...
GO
PRINT N'Creating Table [dbo].[CompanyEmployee]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Beneficiary]...';


GO
ALTER TABLE [dbo].[Beneficiary]
    ADD DEFAULT 0 FOR [AccountStatus];


GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[CompanyEmployee]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd37deed7-47e3-4315-ac7e-ba9f2d049af9')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d37deed7-47e3-4315-ac7e-ba9f2d049af9')
