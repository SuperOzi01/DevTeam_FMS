...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Beneficiary] ([BeneficiaryID], [Username], [Password], [Building_BuildingID], [Role_RoleID])
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_CompanyEmployee] ([EmployeeID], [Username], [Password], [Specialization_idSpecialization], [ManagerID], [Location_idLocation], [Role_idRole])
        SELECT   [EmployeeID],
                 [Username],
                 [Password],
