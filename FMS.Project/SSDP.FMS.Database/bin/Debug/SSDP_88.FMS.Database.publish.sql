...
GO
ALTER TABLE [dbo].[ServiceRequest] DROP CONSTRAINT [DF__ServiceRe__Reque__6D6238AF];
...
GO
PRINT N'Altering Procedure [dbo].[SP_GetCompanyEmployeesList]...';


GO
ALTER PROCEDURE [dbo].[SP_GetCompanyEmployeesList]
AS
	SELECT 
