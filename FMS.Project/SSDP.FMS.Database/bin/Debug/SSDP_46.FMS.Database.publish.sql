...
GO
ALTER TABLE [dbo].[Beneficiary] DROP CONSTRAINT [UQ__tmp_ms_x__A9D10534BC469EF8];
...
GO
ALTER TABLE [dbo].[Beneficiary] DROP CONSTRAINT [UQ__tmp_ms_x__536C85E49464B560];
...
GO
ALTER TABLE [dbo].[CompanyEmployee] DROP CONSTRAINT [UQ__tmp_ms_x__A9D1053421AB14D0];
...
GO
ALTER TABLE [dbo].[CompanyEmployee] DROP CONSTRAINT [UQ__tmp_ms_x__536C85E45DE9B3AA];
